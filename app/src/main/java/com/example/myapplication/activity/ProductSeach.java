...
import com.example.myapplication.adapter.ProductSeachAdapter;
...
public class ProductSeach extends AppCompatActivity {

    private ProductSeachAdapter productAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(ProductSeach.this, ProductActivity.class);
        ...
        productAdapter = new ProductSeachAdapter(initialProductList, this); // Pass context here
