...
public class ProfileActivity extends AppCompatActivity {
    private TextView titleUsername, profileName, profileEmail, profilePhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<CustomerResponseDTO>() {
            ...
            public void onResponse(Call<CustomerResponseDTO> call, Response<CustomerResponseDTO> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    profileName.setText(responseDTO.getFullname());
        ...
        editButton.setOnClickListener(view -> {
            ...
            Call<CustomerResponseDTO> call1 = customerService.getCustomer(customerId);
            call1.enqueue(new Callback<CustomerResponseDTO>() {
                @Override
                public void onResponse(Call<CustomerResponseDTO> call1, Response<CustomerResponseDTO> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        CustomerResponseDTO responseDTO = response.body();
                ...
                @Override
                public void onFailure(Call<CustomerResponseDTO> call1, Throwable t) {
